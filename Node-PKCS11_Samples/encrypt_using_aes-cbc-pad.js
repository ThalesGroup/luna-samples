 ...
 * - For encryption, this sample uses AES_CBC_PAD mechanism.
 */

"use strict";
const { graphene, withSession, usageAndExit, getPlaintext, toHex } = require("./lib/helper");

console.log("\nencrypt_using_aes-cbc-pad.js\n");

if (process.argv.length !== 3) {
  usageAndExit([
    "Usage:",
    "node encrypt_using_aes-cbc-pad.js <slot_label>",
    "",
    "Example:",
    "node encrypt_using_aes-cbc-pad.js myPartition\n",
  ]);
}
