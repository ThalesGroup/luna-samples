...
console.log("\nwrap_secret_key_using_rsa_oaep_sha1.js\n");

if (process.argv.length !== 6) {
  usageAndExit([
    "Usage:",
    "node wrap_secret_key_using_rsa_oaep_sha1.js <slot_label> <rsa_public_key_label> <aes_key_label> <output_filename>",
    "",
    "Example:",
    "node wrap_secret_key_using_rsa_oaep_sha1.js myPartition aws-public-key BYOK-AES BYOK.dat\n",
  ]);
}
