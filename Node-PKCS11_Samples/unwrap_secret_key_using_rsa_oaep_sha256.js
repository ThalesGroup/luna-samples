...
console.log("\nunwrap_secret_key_using_rsa_oaep_sha256.js\n");

if (process.argv.length !== 6) {
  usageAndExit([
    "Usage:",
    "node unwrap_secret_key_using_rsa_oaep_sha256.js <slot_label> <rsa_private_key_label> <unwrapped_key_label> <wrapped_key_file>",
    "",
    "Example:",
    "node unwrap_secret_key_using_rsa_oaep_sha256.js myPartition rsa-pri unwrappedAES BYOK.dat\n",
  ]);
}
