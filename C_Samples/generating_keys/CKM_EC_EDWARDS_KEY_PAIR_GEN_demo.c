...
// This function generates EDDSA key pair.
void generateEDDSAKeyPair()
{
        ...
        CK_BYTE ecParam[] = {0x06, 0x09, 0x2B, 0x06, 0x01, 0x04 ,0x01 ,0xDA ,0x47 ,0x0F ,0x01}; // oid : 1.3.6.1.4.1.11591.15.1
	...
	printf("  --> Private handle : %lu.\n", hPrivate);
	printf("  --> Public handle : %lu.\n", hPublic);
}
