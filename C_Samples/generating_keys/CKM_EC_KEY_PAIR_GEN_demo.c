	...
	OBJECTIVE : This sample demonstrates how to generate ECDSA keypair.
*/
...
void generateECDSAKeyPair()
{
        ...
        CK_BYTE labelPub[] = "MyECPublicKey";
        CK_BYTE labelPri[] = "MyECPrivateKey";
        CK_BBOOL yes = CK_TRUE;
        CK_BBOOL no = CK_FALSE;
        CK_OBJECT_CLASS objClassPub = CKO_PUBLIC_KEY;
        CK_OBJECT_CLASS objClassPri = CKO_PRIVATE_KEY;
        CK_BYTE ecParam[] = {0x06,0x05,0x2B,0x81,0x04,0x00,0x0A}; // EC-CURVE SECP256K1
