...
# - It defaults to CKM_RSA_PKCS_OAEP mechanism, with MGF-SHA1 as the oaep parameter to perform wrapping operation.
...
print ("\nwrap_secret_key_using_rsa_oaep_sha1.py\n")

# Checks for all required arguments.
if len(sys.argv)!=5:
	print ("Usage:")
	print ("./wrap_secret_key_using_rsa_oaep_sha1.py <slot_label> <rsa_public_key_label> <aes_key_label> <output_filename>\n")
	print ("Example:")
	print ("./wrap_secret_key_using_rsa_oaep_sha1.py SP_SKS_SEHSM3 aws-public-key BYOK-AWS-AES BYOK.dat\n")
	quit()
