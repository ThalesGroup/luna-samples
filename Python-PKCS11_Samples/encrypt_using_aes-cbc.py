...
# - For encryption, this sample uses AES-CBC mechanism
...
print("\nencrypt_using_aes-cbc.py\n")


# Prints the syntax for executing this code.
if len(sys.argv)!=2:
	print ("Usage:")
	print ("./encrypt_using_aes-cbc.py <slot_label>")
	print ("\nExample:")
	print ("./encrypt_using_aes-cbc.py SP_SKS_SEHSM3\n")
	quit()
...
if(len(plaintext)%16!=0):
	print("Text too small/big for AES-CBC\n")
	quit()
...
try:
	...
	with p11token.open(user_pin=co_pass) as p11session:
		...
		encrypted_text = secret_key.encrypt(plaintext, mechanism=Mechanism.AES_CBC, mechanism_param=iv); # Encrypts plaintext.
		print ("Plaintext encrypted.")
		decrypted_text = secret_key.decrypt(encrypted_text, mechanism=Mechanism.AES_CBC, mechanism_param=iv); # Decrypts plaintext.
